...
Functions:
  ...
  daily_mean - Calculate daily mean of a 2D inflammation data array.
  daily_max - Calculate a daily max of a 2D inflammation data array.
  daily_min - Calculate a daily min of a 2D inflammation data array.
"""
...
def load_csv(filename):
    ...
    :returns Numpy dataframe of file
    """
...
def patient_normalise(data):
    ...
    if np.any(data < 0):
        raise TypeError('inflammation values should be non-negative')
...
def daily_above_threshold(patient_num, data, threshold):
   ...
   above_threshold = [x>threshold for x in data[patien_num]]
